...
\restrict BsXmEfoWqn1rC71ft38f3UKuhUTpU4s6PYApbnZWHqs3wmbYbXu9mXmbgehrKEO

-- Dumped from database version 16.14
-- Dumped by pg_dump version 16.14

-- Started on 2026-08-05 08:47:31
...
--
-- TOC entry 250 (class 1255 OID 16799)
...
--
-- TOC entry 248 (class 1259 OID 25506)
-- Name: guest_meal; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.guest_meal (
    id bigint NOT NULL,
    department_id bigint NOT NULL,
    requested_by_user_id bigint,
    meal_date date NOT NULL,
    normal_quantity integer DEFAULT 0 NOT NULL,
    special_quantity integer DEFAULT 0 NOT NULL,
    normal_unit_price numeric(10,2),
    special_unit_price numeric(10,2),
    ...
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT guest_meal_quantity_check CHECK (((normal_quantity >= 0) AND (special_quantity >= 0) AND ((normal_quantity + special_quantity) >= 1)))
);


ALTER TABLE public.guest_meal OWNER TO postgres;

--
-- TOC entry 249 (class 1259 OID 25516)
-- Name: guest_meal_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.guest_meal ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.guest_meal_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 4916 (class 2606 OID 16858)
...
--
-- TOC entry 4856 (class 2606 OID 16496)
...
--
-- TOC entry 4878 (class 2606 OID 16575)
...
--
-- TOC entry 4924 (class 2606 OID 25518)
-- Name: guest_meal guest_meal_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.guest_meal
    ADD CONSTRAINT guest_meal_pkey PRIMARY KEY (id);


--
-- TOC entry 4902 (class 2606 OID 16696)
...
--
-- TOC entry 4880 (class 2606 OID 16583)
...
--
-- TOC entry 4900 (class 2606 OID 16682)
...
--
-- TOC entry 4890 (class 2606 OID 16613)
...
--
-- TOC entry 4919 (class 2606 OID 16891)
...
--
-- TOC entry 4864 (class 2606 OID 16512)
...
--
-- TOC entry 4866 (class 2606 OID 16510)
...
--
-- TOC entry 4921 (class 2606 OID 16907)
...
--
-- TOC entry 4906 (class 2606 OID 16706)
...
--
-- TOC entry 4910 (class 2606 OID 16708)
...
--
-- TOC entry 4860 (class 2606 OID 16504)
...
--
-- TOC entry 4876 (class 2606 OID 16556)
...
--
-- TOC entry 4862 (class 2606 OID 16502)
...
--
-- TOC entry 4912 (class 2606 OID 16843)
...
--
-- TOC entry 4914 (class 2606 OID 16841)
...
--
-- TOC entry 4895 (class 2606 OID 16641)
...
--
-- TOC entry 4897 (class 2606 OID 16639)
...
--
-- TOC entry 4882 (class 2606 OID 16909)
...
--
-- TOC entry 4892 (class 2606 OID 16933)
...
--
-- TOC entry 4925 (class 1259 OID 25529)
-- Name: idx_guest_meal_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_guest_meal_date ON public.guest_meal USING btree (meal_date);


--
-- TOC entry 4926 (class 1259 OID 25530)
-- Name: idx_guest_meal_department_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_guest_meal_department_date ON public.guest_meal USING btree (department_id, meal_date);


--
-- TOC entry 4898 (class 1259 OID 16688)
...
--
-- TOC entry 4887 (class 1259 OID 16899)
...
--
-- TOC entry 4917 (class 1259 OID 16898)
...
--
-- TOC entry 4893 (class 1259 OID 16652)
...
--
-- TOC entry 4867 (class 1259 OID 16536)
...
--
-- TOC entry 4868 (class 1259 OID 16535)
...
--
-- TOC entry 4922 (class 1259 OID 25504)
...
--
-- TOC entry 4883 (class 1259 OID 16945)
...
--
-- TOC entry 4960 (class 2620 OID 16825)
...
--
-- TOC entry 4963 (class 2620 OID 16826)
...
--
-- TOC entry 4967 (class 2620 OID 25531)
-- Name: guest_meal update_guest_meal_modtime; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_guest_meal_modtime BEFORE UPDATE ON public.guest_meal FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- TOC entry 4964 (class 2620 OID 16827)
...
--
-- TOC entry 4965 (class 2620 OID 16828)
...
--
-- TOC entry 4962 (class 2620 OID 16830)
...
--
-- TOC entry 4961 (class 2620 OID 16829)
...
--
-- TOC entry 4966 (class 2620 OID 16849)
...
--
-- TOC entry 4956 (class 2606 OID 16859)
...
--
-- TOC entry 4927 (class 2606 OID 16717)
...
--
-- TOC entry 4928 (class 2606 OID 16722)
...
--
-- TOC entry 4940 (class 2606 OID 16727)
...
--
-- TOC entry 4941 (class 2606 OID 16732)
...
--
-- TOC entry 4951 (class 2606 OID 16647)
...
--
-- TOC entry 4958 (class 2606 OID 25519)
-- Name: guest_meal fk_guest_meal_department; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.guest_meal
    ADD CONSTRAINT fk_guest_meal_department FOREIGN KEY (department_id) REFERENCES public.department(id);


--
-- TOC entry 4959 (class 2606 OID 25524)
-- Name: guest_meal fk_guest_meal_requested_by; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.guest_meal
    ADD CONSTRAINT fk_guest_meal_requested_by FOREIGN KEY (requested_by_user_id) REFERENCES public."user"(id);


--
-- TOC entry 4945 (class 2606 OID 16601)
...
--
-- TOC entry 4942 (class 2606 OID 16737)
...
--
-- TOC entry 4943 (class 2606 OID 16586)
...
--
-- TOC entry 4953 (class 2606 OID 16683)
...
--
-- TOC entry 4947 (class 2606 OID 16621)
...
--
-- TOC entry 4949 (class 2606 OID 16772)
...
--
-- TOC entry 4950 (class 2606 OID 16616)
...
--
-- TOC entry 4931 (class 2606 OID 16742)
...
--
-- TOC entry 4929 (class 2606 OID 16752)
...
--
-- TOC entry 4938 (class 2606 OID 16562)
...
--
-- TOC entry 4930 (class 2606 OID 16757)
...
--
-- TOC entry 4933 (class 2606 OID 16762)
...
--
-- TOC entry 4934 (class 2606 OID 16530)
...
--
-- TOC entry 4936 (class 2606 OID 16547)
...
--
-- TOC entry 4935 (class 2606 OID 16767)
...
--
-- TOC entry 4957 (class 2606 OID 16892)
...
--
-- TOC entry 4944 (class 2606 OID 16910)
...
--
-- TOC entry 4955 (class 2606 OID 16844)
...
-- Completed on 2026-08-05 08:47:31

--
-- PostgreSQL database dump complete
--

\unrestrict BsXmEfoWqn1rC71ft38f3UKuhUTpU4s6PYApbnZWHqs3wmbYbXu9mXmbgehrKEO
